...
def display_output():
    ...
    sub_frame2 = Frame(master_frame, bg='black', pady=5, padx = 5)
    ...
    title = Label(master=sub_frame1, text="FAKE CURRENCY DETECTION SYSTEM", fg = 'black', font = "Verdana 20 bold")
    ...
    for i in range(4):
        for j in range(3):
            ...
            if feature_num < 10:     # There are 10 features
                ...
                frame2 = Frame(feature_frame, bg='black', pady=5, padx = 5)
