...
root = Tk() 
root.title("Image Processing Based Fake Currency Detection System")
...
frame2 = Frame(root, bg='black', width=1090, height=400, pady=5, padx = 5)
...
# Title label
title = Label(master=top_frame, text=" FAKE CURRENCY DETECTION SYSTEM", fg = 'black', font = "Verdana 20 bold")
title.pack() # Put the label into the window

# Text label
text1 = Label(master=frame1, text="Welcome to fake currency detection sytem.Upload the image and select the currency type!", fg = 'black', font = "Verdana 10")
text1.pack() 
...
btn = Button(master = frame4, text="Select an image", command=select_image, font = "Verdana 15 bold", fg='black')
btn.pack(side = 'left', padx=10, pady=10)

# Button to submit the image
btn = Button(master = frame4, text="Submit", command=submit, font = "Verdana 15 bold", fg='black')
btn.pack(side = 'left', padx=10, pady=10)

# Button to exit window
btn = Button(master = frame4, text="Exit", command=exit_window, font = "Verdana 15 bold", fg='black')
btn.pack(side = 'left', padx=10, pady=10)
...
get_ipython().run_line_magic('store', 'selectedImage')

if selectedImage == True:
    get_ipython().run_line_magic('store', 'path')
    get_ipython().run_line_magic('store', 'option')
